...
Compare candidate information against a criminal record subject to determine identity match probability. This endpoint uses advanced fuzzy matching algorithms including Fellegi-Sunter probabilistic framework, Jaro-Winkler, Soundex, Levenshtein distance, and keyboard distance to evaluate name, date of birth, SSN, and address similarities.
