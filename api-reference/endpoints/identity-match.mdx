...
Compare candidate information against a criminal record subject to determine identity match probability. This endpoint is part of the Public Records API's identity verification system, which uses advanced fuzzy matching algorithms to ensure accurate identity resolution.
